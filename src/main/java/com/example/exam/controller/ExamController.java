...
public class ExamController {
    ...
    public String submitExam(@RequestParam Long examId,
                             ...
                             @RequestParam(required = false) String disqualifyReason,
        ...
        // Disqualification wiring
        if (disqualifyReason != null && !disqualifyReason.trim().isEmpty()) {
            result.setDisqualified(true);
            result.setDisqualifyReason(disqualifyReason);
        }
